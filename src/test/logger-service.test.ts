...
describe('LoggerService', () => {
    ...
    describe('#formatMessage', () => {
        test('should return a string with the timestamp', () => {
            ...
            // @ts-ignore
            const result = LoggerService.formatMessage(logger.namespace, message, true);
            expect(typeof result).toEqual('string');
            expect(result).toContain(message);
            expect(result).toContain(logger.namespace);
        });
        ...
        test('should return a string without the timestamp', () => {
            ...
            // @ts-ignore
            const result = LoggerService.formatMessage(logger.namespace, message, false);
            expect(typeof result).toEqual('string');
            expect(result).toContain(message);
            expect(result).toContain(logger.namespace);
        });
