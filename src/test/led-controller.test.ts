...
describe('LedController:', () => {
    ...
    describe('executeAction', () => {
        ...
        ('should run correct method when running executeAction(%p, %p)', (action: string, parameters: number[], command: string ) => {
            board.online = true;
            board.serialWriteBytes = jest.fn();

            board.executeAction(action, parameters);

            expect( board.serialWriteBytes ).toHaveBeenCalledWith(FirmataBoard.SERIAL_PORT_ID.SW_SERIAL0, ["[", command, ...parameters, "]"]);
        });
    });
    ...
    describe('pulseColor', () => {
        describe('happy flows', () => {
            test('should execute serialWriteBytes', () => {
                ...
                expect(board.serialWriteBytes).toHaveBeenCalledWith(FirmataBoard.SERIAL_PORT_ID.SW_SERIAL0, ["[", "P", 255, 255, "]"]);
            });
        });
    ...
    describe('setColor', () => {
        describe('happy flows', () => {
            test('should execute serialWriteBytes', () => {
                ...
                expect(board.serialWriteBytes).toHaveBeenCalledWith(FirmataBoard.SERIAL_PORT_ID.SW_SERIAL0, ["[", "C", 255, 255, 255, "]"]);
            });
        });
    ...
    describe('kitt', () => {
        describe('happy flows', () => {
            test('should execute serialWriteBytes', () => {
                ...
                expect(board.serialWriteBytes).toHaveBeenCalledWith(FirmataBoard.SERIAL_PORT_ID.SW_SERIAL0, ["[", "K", 255, 255, 255, "]"]);
            });
        });
    ...
    describe('rainbow', () => {
        describe('happy flows', () => {
            test('should execute serialWriteBytes', () => {
                ...
                expect(board.serialWriteBytes).toHaveBeenCalledWith(FirmataBoard.SERIAL_PORT_ID.SW_SERIAL0, ["[", "R", "]"]);
            });
        });
    });
    ...
    describe('parametersAreValid', () => {
        ...
        ('should return true when running parametersAreValid(%p)', ( parameters: any[] ) => {
            // @ts-ignore
        ...
        ('should return false when running parametersAreValid(%p)', ( parameters: any[] ) => {
            // @ts-ignore
            const result = LedController.parametersAreValid(parameters);
