...
import {AVAILABLE_EXTENSIONS_CLASSES, AVAILABLE_EXTENSIONS_KEYS, isAvailableExtension} from "../domain/board/extension";
...
export class BoardDAO {
    ...
    public static async getAll (): Promise<Board[]> {
        return await Board.findAll()
            .then((boards: Board[]) => boards.map( (board: Board) => BoardDAO.createBoardInstance(board.getDataValues())));
    }
