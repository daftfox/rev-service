...
var JSON = Mocha.reporters.JSON;
const ProgramService_1 = require("./ProgramService");
/**
...
class WebSocketService {
    ...
    constructor(port, model) {
        ...
        this.httpServer = new http_service_1.default(port).server;
        this.model = model;
    ...
    startWebSocketServer() {
        ...
        this.log.info(`Listening on port ${chalk_1.default.rgb(240, 240, 30).bold(JSON.stringify(this.httpServer.address().port))}.`);
    ...
    handleMessageReceived(message) {
        ...
        switch (webSocketMessage.type) {
            case web_socket_message_2.WebSocketMessageType.COMMAND_EVENT:
                ...
                ProgramService_1.default.executeProgram(board, [
                    {
                        action: "TOGGLELED",
                    }
                ]);
